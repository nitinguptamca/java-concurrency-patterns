...
public class BiFunctionExample {
    ...
    static BiFunction<String,String,String> getLoginLocs =
            (sLocator,elementType) -> loginPageLocs.get(sLocator);

    public static void main(String[] args) {

        System.out.println(biFunction.apply(StudentDataBase.getAllStudents(),PredicateStudentExample.p2));
        Map<String, Double> result = biFunction.apply(StudentDataBase.getAllStudents(), PredicateStudentExample.p2);
